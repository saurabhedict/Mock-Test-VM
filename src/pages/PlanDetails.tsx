...
import { ArrowLeft, CheckCircle2, BookOpen, Users, Target, Rocket, Zap, HelpCircle, ArrowRight, Loader2 } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-4">
          ...
          <p className="mt-4 text-muted-foreground font-medium">Loading plan details...</p>
        </main>
        <Footer />
      </div>
    );
          ...
          <div className="container relative z-10 max-w-6xl mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              >
                ...
                <div className="inline-flex items-center gap-2 text-sm text-primary bg-primary/5 shadow-sm border border-primary/10 rounded-lg px-4 py-3">
                  <CheckCircle2 className="w-5 h-5 text-primary" />
                  <span className="font-semibold">Validity:</span> {formatPlanValidityLabel(plan)}
                </div>
              ...
              >
                <div className="bg-card border-none ring-1 ring-border/50 rounded-3xl p-8 shadow-2xl relative overflow-hidden backdrop-blur-sm z-10">
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex items-center gap-3 text-muted-foreground">
                      <CheckCircle2 className="w-5 h-5 text-primary" />
                      <span className="font-medium text-foreground/80">{formatPlanValidityLabel(plan)}</span>
                    </div>
                  </div>
