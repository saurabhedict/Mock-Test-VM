...
import { isPurchaseActive } from "@/lib/planValidity";
...
export default function BuyButton({
  ...
  const hasActivePurchase = (user as unknown as { purchases?: { featureId: string; expiresAt?: string | null }[] })
    ?.purchases?.some((p) => p.featureId === featureId && isPurchaseActive(p));
